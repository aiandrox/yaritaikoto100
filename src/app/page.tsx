import { useCurrentListFacade } from "./facade/currentList.facade";
...
export default function Home() {
  ...
  return (
    <>
      <main className="flex flex-col items-center" style={{ backgroundColor: "#ffa2ab" }}>
