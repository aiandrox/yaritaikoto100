...
export type CurrentListQueryQuery = { __typename?: 'Query', currentList: { __typename?: 'List', uuid: string, title: string, published: boolean, items: Array<{ __typename?: 'Item', number: number, name: string, doneAt?: string | null }> } };
